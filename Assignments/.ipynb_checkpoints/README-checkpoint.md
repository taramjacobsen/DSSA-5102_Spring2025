...
|planet_mass_earth_limit_flag |Flag indicating whether the planet mass is based on a limit (-1=yes, 0=no) |
...
| planet_mass_jupiter_limit_flag|Flag indicating whether the planet mass is based on a limit (-1=yes, 0=no) |
...
|planet_density_limit_flag |Flag indicating whether the planet density is based on a limit (-1=yes, 0=no) |
...
| eccentricity_limit_flag| Flag indicating whether the eccentricity is based on a limit (-1=yes, 0=no)|
...
|insolation_flux_limit_flag |Flag indicating whether the insolation flux is based on a limit (-1=yes, 0=no) |
...
| equilibrium_temperature_limit_flag|Flag indicating whether the equilibrium temperature flux is based on a limit (-1=yes, 0=no) |
...
| inclination_limit_flag|Flag indicating whether the inclination degree is based on a limit (-1=yes, 0=no) |
...
|impact_parameter_limit_flag |Flag indicating whether the impact parameter is based on a limit (-1=yes, 0=no) |
...
|transit_depth_limit_flag |Flag indicating whether the transit depth is based on a limit (-1=yes, 0=no) |
...
|transit_duration_limit_flag | Flag indicating whether the transit duration is based on a limit (-1=yes, 0=no)|
...
|ratio_semi_major_axis_to_stellar_radius_limit_flag |Flag indicating whether the semi major axis ratio is based on a limit (-1=yes, 0=no) |
...
| ratio_planet_to_stellar_radius_limit_flag| Flag indicating whether the ratio of the planet to stellar radius is based on a limit (-1=yes, 0=no) |
...
|epoch_of_periastron_limit_flag | Flag indicating whether the time of the planet's periastron passage is based on a limit (-1=yes, 0=no)|
...
|argument_of_periastron_limit_flag |Flag indicating whether the angular seperation between the orbit's ascending node and periastron is based on a limit (-1=yes, 0=no)|
